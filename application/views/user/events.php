...
<body class="text-gray-800 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Explore and register for our exciting workshops, hackathons, and networking sessions.</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-5 mb-10">
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 items-center">
                ...
                <div>
                    <select id="sort-order" class="w-full p-3 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent" onchange="renderEvents()">
        ...
        <div id="no-events-message" class="hidden text-center py-20 bg-white rounded-xl shadow-lg border border-gray-200">
            ...
            <p class="text-gray-600 mt-2">The current filters returned no matching future events.</p>
    ...
    <script>
        ...
        function renderEvents() {
            ...
            // Base Filter: FUTURE events only
                        ...
                        <div class="fade-in-up group bg-white rounded-xl border border-gray-200 shadow-md hover:shadow-xl transition-all duration-500 overflow-hidden flex flex-col h-full hover:ring-2 ${style.ring}/50 cursor-pointer" onclick="openModal(${event.id})" style="animation-delay: ${delay}ms">
                            ...
                            <div class="p-6 flex-grow">
                                <div class="flex justify-between items-center mb-3">
                                    ...
                                    <span class="text-xs font-bold text-primary bg-yellow-50 px-2 py-0.5 rounded-full border border-yellow-200">
                            ...
                            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                                ...
                                <form action="<?= base_url('events/register/') ?>${event.id}" method="post" style="display:inline;">
                                    <button type="submit" class="text-sm font-semibold text-white bg-primary hover:bg-primary-dark rounded-lg px-3 py-1.5 transition shadow-sm">
                                        Register →
                                    </button>
                                </form>
                            </div>
                    ...
                    <div class="fixed inset-0 z-10 overflow-y-auto">
                        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                            <div class="relative transform rounded-2xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-xl scale-95 opacity-0 modal-panel">
                                ...
                                <div class="bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse sm:px-6 border-t border-gray-200 rounded-b-2xl">
                                    <form action="<?= base_url('events/register/') ?>${event.id}" method="post" style="display:inline; flex:1;">
                                        <button type="submit" class="mt-3 inline-flex w-full justify-center rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white shadow-md hover:bg-primary-dark transition sm:mt-0 sm:ml-3 sm:w-auto">
                                            Register Now
                                        </button>
                                    </form>
